 <div class="container" data-aos="fade-up">
            ...
            <div class="section-title">
                ...
                <p>Having trouble here, these are some of the questions we have received from other members, hope they help. If you can't find what you are looking for, then email us above or contact us below.</p>
            </div>
                ...
                <ul>
                    <li data-aos="fade-up" data-aos-delay="100">
                        <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" class="collapse"
                            data-bs-target="#faq-list-1">How do I join the club<i
                                class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                        <div id="faq-list-1" class="collapse show" data-bs-parent=".faq-list">
                            <p>
                               Through buying a shirt.
                            </p>
                        </div>
                    </li>
